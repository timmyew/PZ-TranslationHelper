...
public class ExceptionConstants {
    ...
    public static final String FILE_IO_READ_EXCEPTION = "Failed to read file with path: '%s'";
    public static final String FILE_IO_WRITE_EXCEPTION = "Failed to write file to the path: '%s'";
